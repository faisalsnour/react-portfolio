                    ...
                    <div className="row">
                        <div className="col">
                            <div style={{ textAlign: "center", marginBottom: "15px", marginTop: "15px" }}>
                                <p style={{ marginBottom: "10px" }}>Connect with me through</p>
                                <p style={{ marginBottom: "10px" }}><a style={{ color: "white", textDecoration: "none" }} target="_blank" rel="noreferrer" href="mailto:faisalskhalifa@gmail.com">faisalskhalifa@gmail.com </a>| <span>(647) 309 - 5646</span></p>
